...
def enter_username():
    """Function for handling operations with the main page.
    Gets requests from HTML forms and provides main with args to find people.
    Renders webpages for flask.

    Returns:
        _type_: Rendered web page.
    """
...
def show_map():
    """Function for handling operations with the big map page.
    Gets requests from HTML form on the big map page and reacts on this.
    Renders big map page and handles return to main page.
...
def get_map_info(following_info: list, num_of_friends: int) -> list:
    ...
    Args:
        ...
        num_of_friends (int): Number of friends to show on the map.
